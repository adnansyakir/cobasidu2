...
@section('title', 'Profile Admin - SIDU')
...
<div class="profile-grid">
    <div class="profile-photo-card">
        ...
        <div class="photo-actions">
            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" id="photoForm">
                @csrf @method('PUT')
            ...
            @if($user->foto_profil)
            <form action="{{ route('admin.profile.delete-photo') }}" method="POST">
                @csrf @method('DELETE')
