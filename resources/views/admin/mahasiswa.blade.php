...
<div class="modal-overlay" id="addModal"><div class="modal-box">
    ...
    <form action="{{ route('admin.mahasiswa.store') }}" method="POST">@csrf
        ...
        <div class="form-row-3">
            ...
            <div class="form-group"><label>Tanggal Lahir *</label><input type="date" name="tgl_lahir" class="form-control" value="{{ old('tgl_lahir') }}" required><small class="text-muted"></small></div>
        </div>
