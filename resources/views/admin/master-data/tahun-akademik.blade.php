                ...
                <tr>
                    ...
                    <td>
                        <div class="action-group">
                            ...
                            <form action="{{ route('admin.master-data.tahun-akademik.destroy',$item->id) }}" method="POST" onsubmit="return confirm('Yakin hapus?')">@csrf @method('DELETE')<button type="submit" class="btn-action btn-delete">🗑️</button></form>
                        </div>
                    </td>
                </tr>
                @empty
...
<div class="modal-overlay" id="addModal"><div class="modal-box">
    ...
    <form action="{{ route('admin.master-data.tahun-akademik.store') }}" method="POST">@csrf
...
function openEdit(id,tahun,semester,status){
    document.getElementById('editForm').action='/admin/master-data/tahun-akademik/'+id;
