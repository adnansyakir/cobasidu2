                ...
                <tr>
                    ...
                    <td>
                        <div class="action-group">
                            ...
                            <form action="{{ route('admin.master-data.status-pembayaran.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin hapus status ini?')">
                                @csrf @method('DELETE')
...
<div class="modal-overlay" id="addModal"><div class="modal-box">
    ...
    <form action="{{ route('admin.master-data.status-pembayaran.store') }}" method="POST">@csrf
...
function openEdit(id, nama, ket) {
    document.getElementById('editForm').action = '/admin/master-data/status-pembayaran/' + id;
