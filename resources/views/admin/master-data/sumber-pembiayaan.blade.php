                ...
                <tr>
                    ...
                    <td>
                        <div class="action-group">
                            ...
                            <form action="{{ route('admin.master-data.sumber-pembiayaan.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin hapus sumber pembiayaan ini?')">
                                @csrf @method('DELETE')
...
<div class="modal-overlay" id="addModal"><div class="modal-box">
    ...
    <form action="{{ route('admin.master-data.sumber-pembiayaan.store') }}" method="POST">@csrf
...
function openEdit(id, nama) {
    document.getElementById('editForm').action = '/admin/master-data/sumber-pembiayaan/' + id;
