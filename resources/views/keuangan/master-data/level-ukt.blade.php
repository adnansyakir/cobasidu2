                ...
                <tr>
                    ...
                    <td>
                        <div class="action-group">
                            ...
                            <form action="{{ route('keuangan.master-data.level-ukt.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin hapus level UKT ini?')">
                                @csrf @method('DELETE')
...
<div class="modal-overlay" id="addModal"><div class="modal-box">
    ...
    <form action="{{ route('keuangan.master-data.level-ukt.store') }}" method="POST">@csrf
...
function openEdit(id, nama, ket) {
    document.getElementById('editForm').action = '/keuangan/master-data/level-ukt/' + id;
