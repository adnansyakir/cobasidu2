...
@section('title', 'Profile Akademik - SIDU')
@section('page-title', 'Profile Akademik')
...
<div class="profile-grid">
    <div class="profile-photo-card">
        ...
        <div class="photo-actions">
            <form action="{{ route('akademik.profile.update') }}" method="POST" enctype="multipart/form-data" id="photoForm">
                @csrf @method('PUT')
            ...
            @if($user->foto_profil)
            <form action="{{ route('akademik.profile.delete-photo') }}" method="POST">
                @csrf @method('DELETE')
    ...
    <div>
        <div class="profile-form-card">
            ...
            <form action="{{ route('akademik.profile.update') }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PUT')
                <div class="form-row">
