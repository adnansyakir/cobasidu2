...
@section('title', 'Profile Direktur - SIDU')
@section('page-title', 'Profile Direktur')
...
<div class="profile-grid">
    <div class="profile-photo-card">
        ...
        <div class="photo-actions">
            <form action="{{ route('direktur.profile.update') }}" method="POST" enctype="multipart/form-data" id="photoForm">
                @csrf @method('PUT')
            ...
            @if($user->foto_profil)
            <form action="{{ route('direktur.profile.delete-photo') }}" method="POST">
                @csrf @method('DELETE')
    ...
    <div>
        ...
        <div class="password-card">
            ...
            <form action="{{ route('direktur.profile.password') }}" method="POST">
                @csrf @method('PUT')
                <div class="form-row single">
                    <div class="form-group">
